...
/**
 * Das Ergebnis der Verarbeitung eines Satzes durch eine {@link BatchAusfuehrungsBean} Bean.
 *
 *
 */
public class VerarbeitungsErgebnis {
     ...
     * @param schluessel
     *            der Datenbankschluessel
     * @param alleSaetzeVerarbeitet
     *            wahr, falls alle Saetze verarbeitet werden.
     */
    public VerarbeitungsErgebnis(String schluessel, boolean alleSaetzeVerarbeitet) {
        this.datenbankSchluessel = schluessel;
    ...
    public String getDatenbankSchluessel() {
        return this.datenbankSchluessel;
    }

    /**
     * @param datenbankSchluessel
     *            the datenbankSchluessel to set
     */
    ...
    public boolean isAlleSaetzeVerarbeitet() {
        return this.alleSaetzeVerarbeitet;
    }

    /**
     * @param alleSaetzeVerarbeitet
     *            the alleSaetzeVerarbeitet to set
     */
